...
<body>
    <s:form action="/action/financeHQJSP!editFHQBill" method="POST" name="financeBillForm"  id="financeBillForm" theme="simple">
     <s:hidden name="formBean.financeBill.id"/> 
		      ...
		      <td colspan="7">
						...
						<table width="100%"  align="left" border="0" id="org_table">
						   ...
						   <tr class="InnerTableContent">
						     <td width="180" height="35">单据种类 ： <s:property value="uiBean.financeBill.typeHQS"/></td>
						     <td width="220">连锁店 ： <s:property value="uiBean.financeBill.chainStore.chain_name"/> </td>
						     <td width="220">过账日期:<s:date name="uiBean.financeBill.createDate" format="yyyy-MM-dd" /></td>
					       </tr>
						   <tr class="InnerTableContent">	      
							 <td height="25">经手人:<s:property value="uiBean.financeBill.creatorHq.user_name"/></td>
							 <td> 状态 ： <s:if test="uiBean.financeBill.status == 3"><font style="color:red"><s:property value="uiBean.financeBill.statusS"/></font></s:if><s:else>
							 				<s:property value="uiBean.financeBill.statusS"/>
							 		   </s:else>
							 </td>
							 <td>备注 ： <s:property value="uiBean.financeBill.comment"/></td>
					       </tr>
					       <tr class="InnerTableContent">	
					         <td height="25">折扣:<s:property value="uiBean.financeBill.invoiceDiscount"/></td>      
							 <td>上欠:<s:property value="uiBean.financeBill.preAcctAmt"/></td>
							 <td>下欠 ： <s:property value="uiBean.financeBill.postAcctAmt"/></td>
					       </tr>
				       </table>
			      </td>
			    </tr>
				...
				<tr>
				  <td><table width="100%"  align="left" class="OuterTable" id="org_table">
	                  ...
	                  <s:iterator value="uiBean.financeBill.financeBillItemList" status="st" id="billItem" >
