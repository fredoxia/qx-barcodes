			    ...
			    <tr>
			       <td height="50" colspan="7">
				       ...
				       <tr class="InnerTableContent">
				         ...
				         <td width="334">状态:<s:property value="uiBean.flowOrder.statusS"/></td>
				       </tr>
				     </table></td>
			    </tr>
			    <tr class="InnerTableContent">
						...
						<table width="100%"  align="left" class="OuterTable" id="org_table">
						  ...
						  <tbody id="orderTablebody">
						      <s:iterator value="uiBean.flowOrder.productList" status = "st" id="orderProduct" >
						  		<tr class="InnerTableContent" id="orderRow0" class="InnerTableContent" align='center' <s:if test="#st.odd">style='background-color: rgb(255, 250, 208);'</s:if>>   
							      ...
							      <td><s:property value="#orderProduct.quantityDiff"/></td>
						  ...
						  <tr class="PBAInnerTableTitale">
						    ...
						    <th align='center'><s:property value="uiBean.flowOrder.totalInventoryQ"/></th>
						    <th align='center'><s:property value="uiBean.flowOrder.totalQuantityDiff"/></th>
						    <th></th>
						  </tr>
					     </table>
			      </td>
