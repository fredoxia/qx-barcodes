...
function preSearch(){
    document.chainPurchaseStatisForm.action="chainReportJSPAction!prePurchaseStatisticReport";
    document.chainPurchaseStatisForm.submit();
}
</script>
</head>
			      ...
			      <td colspan="7">
						...
						<table width="100%"  align="left" class="OuterTable" id="org_table">
						  ...
						  <tbody id="orderTablebody">
						      <s:iterator value="uiBean.purchaseStatisLevelOne" status = "st" id="ci" >
						  ...
						  <s:if test="uiBean.purchaseStatisLevelOne.size >0">
							  <tr class="PBAInnerTableTitale">
							    <td colspan="2" align="left">合计</th>
