...
<script>
	...
	<table class="easyui-datagrid"  style="width:520px;height:320px" data-options="singleSelect:true,border : false">
		<thead>
		    <tr>
		      ...
		      <th data-options="field:'8',width:50">总销量</th>
		      <th data-options="field:'9',width:50">我的销量</th>
		    </tr>
		</thead>
		<tbody>
		    <s:iterator value="uiBean.hotMProducts" status = "st" id="hotProduct" >
			    <tr>
			      ...
			      <td><s:text name="format.quantity">  
    					   <s:param value="#hotProduct.salesQuantity"/>  
					  </s:text></td>
			      <td><s:text name="format.quantity">  
			             <s:param value="#hotProduct.mySalesQuantity"/>
			          </s:text></td>
			    </tr>
		    </s:iterator>
		 </tbody>
