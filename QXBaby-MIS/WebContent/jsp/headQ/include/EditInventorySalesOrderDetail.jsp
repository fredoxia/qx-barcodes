                ...
                <tbody  id="inventoryTable">
	                <s:iterator value="formBean.order.product_List" status = "st" id="orderProduct" >
					 	<tr id="row<s:property value="#st.index"/>"  class="excelTable">
					 		...
					 		<td><input type="text" name="formBean.order.product_List[<s:property value="#st.index"/>].productBarcode.product.brand.brand_Name" id="brand<s:property value="#st.index"/>" readonly="readonly"  size='22' value="<s:property value="#orderProduct.productBarcode.product.brand.brand_Name"/> <s:property value="#orderProduct.productBarcode.product.brand.comment"/>"/></td>			 					 		
				 	...
				 	<tr height="22" id="row<s:property value='formBean.order.product_List.size()'/>" class="excelTable">
					 	...
					 	<td><input type="text" name="formBean.order.product_List[<s:property value='formBean.order.product_List.size()'/>].productBarcode.product.brand.brand_Name" id="brand<s:property value='formBean.order.product_List.size()'/>" readonly="readonly"  size='22'/></td>			 					 		
