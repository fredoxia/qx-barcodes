...
<script type="text/javascript" src="<%=request.getContextPath()%>/conf_files/jQM/jquery-1.8.0.min.js?v=3.27"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/conf_files/js/qxbaby-mobile.js?v=3.28"></script>