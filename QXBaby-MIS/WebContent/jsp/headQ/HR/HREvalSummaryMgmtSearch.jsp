...
function searchPeopleEval(){
	if (validateForm()){
	    ...
	    $.post("hrEvalJSON!searchPeopleEvalSummary",params, searchPeopleEvalBackProcess,"json");	
	}
}
...
<body>
	...
	<s:form id="peopleEvalSearchForm" action="/action/hrEvalJSON!searchPeopleEvalSummary" method="POST" theme="simple" onsubmit="return validateForm();">
		 ...
		 <table width="100%" border="0">
		    ...
		    <tr class="InnerTableContent">
		      <td width="41" height="32">
		         <strong>年</strong></td>
		      <td width="121"><s:select id="year" name="searchEval.year"  list="year" headerKey="0" headerValue="-------" /></td>
		      <td width="20"><strong>月</strong></td>
		      <td width="77"><s:select id="month" name="searchEval.month"  list="month" headerKey="-1" headerValue="--所有月份--" /></td>
		      <td width="87"><strong>被评估人员</strong></td>
		      <td width="245"><s:select id="evaluatee" name="searchEval.evaluatee"  list="users" listKey="user_id" listValue="user_name" headerKey="0" headerValue="-------" /></td>
		      <td width="385">&nbsp;</td>
		    </tr>
		    <tr class="InnerTableContent">
