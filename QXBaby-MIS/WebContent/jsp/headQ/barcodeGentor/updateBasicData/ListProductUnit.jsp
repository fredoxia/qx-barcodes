	...
	dataGrid = $('#dataGrid').datagrid({
		...
		columns : [ [ {
				...
				formatter : function(value, row, index) {
					var str = '';
					str += $.formatString('<a href="#" onclick="EditProductUnit(\'{0}\');"><img border="0" src="{1}" title="编辑单位"/></a>', row.id, '<%=request.getContextPath()%>/conf_files/easyUI/themes/icons/text_1.png');
					return str;
				}
		}]],
		toolbar : '#toolbar',
...
function EditProductUnit(unitId){
	var params = "formBean.basicData=productUnit";
	if (unitId != 0)
	   params += "&formBean.basicDataId =" + unitId;
	...
	<div class="easyui-layout" border="false" style="width:400px;height:650px">
		...
		<div data-options="region:'center',border:false">
			...
			<div id="toolbar" style="display: none;">
		             <a onclick="EditProductUnit(0);" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">添加</a>
