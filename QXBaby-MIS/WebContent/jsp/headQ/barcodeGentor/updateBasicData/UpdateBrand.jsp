...
function updateBrandBKProcess(data){
    ...
    <s:form id="updateBrandForm" name="updateBrandForm" method="post" action="action/basicData!saveUpdateBrand" cssClass="easyui-form"  theme="simple" onsubmit="return validateForm();">
