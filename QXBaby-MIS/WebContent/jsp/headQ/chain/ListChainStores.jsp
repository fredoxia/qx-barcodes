...
pageNav.fn = function(page,totalPage){                
    ...
    document.chainListForm.action="chainSMgmtJSP!listChainStoreHQ";
...
<body>
   <s:form action="chainSMgmtJSP!listChainStoreHQ" method="POST" name="chainListForm" id="chainListForm" theme="simple"> 
