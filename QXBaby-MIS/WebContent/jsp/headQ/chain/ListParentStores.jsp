...
pageNav.fn = function(page,totalPage){                
    ...
    document.chainListForm.action="chainSMgmtJSP!listParentStore";
    document.chainListForm.submit();
};

function selectChainStore(chainId, chainName){
	 window.opener.selectParentStore(chainId, chainName); 
	 window.close();
}
</script>
</head>
<body>
   <s:form action="chainSMgmtJSP!listParentStore" method="POST" name="chainListForm" id="chainListForm" theme="simple"> 
