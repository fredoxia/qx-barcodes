...
<!-- this Footer is used by the sales out order and sales exchange order for view-->
				  	...
				  	<table width="100%" border="0">
					       <tr class="InnerTableContent">
					         ...
					         <td colspan="9"><s:property value="uiBean.chainSalesOrder.memo"/></td>
					         <td>&nbsp;</td>
				           </tr>
					       <tr class="InnerTableContent">
						   ...
						   <tr class="InnerTableContent">
					         <td height="25"><br/>           </td>
					         <td><strong>积分换现金</strong></td>
					         <td><s:property value="uiBean.chainSalesOrder.vipScore"/></td>
					       ...
					       <tr class="InnerTableContent">
					         <td colspan="12"><hr width="100%" color="#FFCC00"/></td>
				           </tr>
					       <tr class="InnerTableContent">
					         <td height="25">&nbsp;</td>
					         <td colspan="8"></td>
